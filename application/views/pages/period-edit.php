                      ...
                      <div class="row">
                        <div class="form-group col-md-12">
                          ...
                          <select class="form-control select2" name="status" id="status" autocomplete="off" required>
                            <option value="Active" <?php if($perioddata->status=="Active") {echo "selected"; } ?>>Active</option>
                            <option value="Inactive" <?php if($perioddata->status=="Inactive") {echo "selected"; } ?>>Inactive</option>
                          </select>
                        </div>
                      </div>
                    </div>
