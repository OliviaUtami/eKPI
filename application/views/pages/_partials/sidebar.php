      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($menu=="dashboard"){ echo "active"; } ?>"><a class="nav-link" href="<?php echo base_url()."dashboard"; ?>"><i class="fas fa-users"></i> <span>Dashboard</span></a></li>
            ...
            <li class="<?php if($menu=="indicator"){ echo "active"; } ?>"><a class="nav-link" href="<?php echo base_url()."indicator"; ?>"><i class="fas fa-list"></i><span>Indikator</span></a></li>
            <li class="<?php if($menu=="indicator-approval"){ echo "active"; } ?>"><a class="nav-link" href="<?php echo base_url()."indicator"; ?>"><i class="fas fa-list"></i><span>Indikator Persetujuan</span></a></li>
          </ul>
