        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo base_url(); ?>dist/index">
              <span style="display: flex;justify-content: space-around;line-height: 100%;margin-top: 15px; font-weight:bolder;">E-KPI</span>
              <span style="display: flex;justify-content: space-around;line-height: 100%;margin-top: 10px; font-weight:bolder;">UWIKA</span>
            </a>
          </div>
